sap.ui.define([
	"sap/ui/test/Opa5",
	"ein/codes/tax/payment/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("ein.codes.tax.payment.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "PaymentSet/" + sObjectId;
